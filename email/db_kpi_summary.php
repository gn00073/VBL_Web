...
echo "<h4> Please find below status of RD Uploaded Sales Volume as on " .  $KPI_Date . "</h4>";

$subject="RD Uploaded Sales Volume as on " .  $KPI_Date ;
...
<h4>Note: This is a system generated E-mail. Please do not reply.</h4>

<?php

$message .= "<h4>Note: This is a system generated E-mail. Please do not reply.</h4> ";

$header = "From:gihan@thebpp.co.uk \r\n";
         $header .= "Cc:gihankumara20006@gmail.com \r\n";
         $header .= "MIME-Version: 1.0\r\n";
         $header .= "Content-type: text/html\r\n";

$to="gihan.kumara@varunlanka.com";
