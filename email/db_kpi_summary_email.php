...
$message .= "<h4> Please find the below mentioned status of RD Sales Uploaded as on " .  $KPI_Date . "</h4>";

$subject .="RD Sales Uploaded as on " .  $KPI_Date ;
